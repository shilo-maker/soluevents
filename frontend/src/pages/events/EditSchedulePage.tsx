    ...
    const flowItems: ProgramItem[] = flowSongs.map((fs) => {
      ...
      if (fs.segmentType === 'prayer') {
        ...
        return {
          ...
          type: 'prayer',
          title: fs.segmentTitle || prayerData.title || t('events.schedule.prayer', 'Prayer'),
                  ...
                  <div className="flex items-center justify-between p-3 bg-white/15 backdrop-blur-sm border border-white/20 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-white/70">{link.songCount} {link.songCount !== 1 ? t('events.schedule.items', 'items') : t('events.schedule.item', 'item')}</p>
                      </div>
                    </div>
